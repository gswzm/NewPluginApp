package com.gsww.baselibs.view.wheelview.lib;
...
import com.gsww.baselibs.view.wheelview.adapter.WheelAdapter;
import com.gsww.baselibs.view.wheelview.listener.OnItemSelectedListener;
...
public class WheelView extends View
{
	...
	public WheelView(Context context, AttributeSet attrs)
	{
		...
		if (attrs != null)
		{
			...
			mGravity = a.getInt(R.styleable.wheelview_wheelGravity, Gravity.CENTER);
		...
		while (counter < itemsVisible)
		{
			...
			} else
			{
				...
				} else if (translateY >= firstLineY && maxTextHeight + translateY <= secondLineY)
				{
					...
					canvas.drawText(contentText, drawCenterContentStart, maxTextHeight - 3, paintCenterText);
