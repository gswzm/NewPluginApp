...
public class MPluginHelper {

    private static MPluginHelper instance = null;

    private MPluginHelper() {
    }

    public static MPluginHelper getInstance() {
        if (instance == null) {
            instance = new MPluginHelper();
        }
        return instance;
    }
    ...
    public void installPlugin(final Context context, final String pluginName, final String activityName, boolean isUpdate) {
        ...
        if (info != null) {
            MainInfoConfig.saveMainInfo(context,info.getVersion());
